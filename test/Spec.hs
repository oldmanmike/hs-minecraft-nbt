...
instance Arbitrary NBTList where
  arbitrary = do
    ...
    case tagID of
      ...
      0x07 -> NBTList <$> return TypeByteArray <*> vectorOf i (NTagByteArray <$> (arbitrary :: Gen (AU.UArray Int32 Int8)))
      0x08 -> NBTList <$> return TypeString <*> vectorOf i (NTagString <$> (arbitrary :: Gen T.Text))
      0x09 -> NBTList <$> return TypeList <*> vectorOf i (NTagList <$> arbitrary)
      0x0a -> NBTList <$> return TypeCompound <*> vectorOf i (NTagCompound <$> listOf (arbitrary :: Gen NBT))
      0x0b -> NBTList <$> return TypeIntArray <*> vectorOf i (NTagIntArray <$> (arbitrary :: Gen (AU.UArray Int32 Int32)))
